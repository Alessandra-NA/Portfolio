    ...
    <section className='mb-20'>
      ...
      <div className="flex">
        ...
        <div className='ml-4 border-l-2 border-amethyst-300 pl-8 relative'>
          ...
          <div className='my-4'>
            <h3 className='text-2xl font-semibold text-amethyst-500 my-2'>Full Stack Developer + IA Engineer</h3>
            <h4 className='font-semibold lg:hidden'>Julio 2023 - Diciembre 2023</h4>
          </div>
          <h5 className='text-amethyst-500 font-medium my-3'>Chatbot Web + IA</h5>
          ...
          <h5 className='text-amethyst-500 font-medium my-3'>Implementación y gestión del software "OpenClinic"</h5>
      ...
      <div className="flex">
        ...
        <div className='ml-4 border-l-2 border-amethyst-300 pl-8 relative'>
          ...
          <h5 className='text-amethyst-500 font-medium my-3'>Web de compra de boletos para concurso SERNANP</h5>
          <ol className='list-disc ml-8 mb-8'>
